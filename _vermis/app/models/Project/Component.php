 ...
 * @brief   Project_Component model.
 */
class Project_Component extends FreeCode_Doctrine_Record
{
    
    public function setTableDefinition()
    {
        parent::setTableDefinition();
        $this->setTableName('project__component');
        ...
        $this->index('project__component_unique_idx', array(
    ...
    public function postInsert($event)
    {
        ...
        ActivityObserver::getInstance()->notifyComponent($this, Log::ACTION_INSERT);
    }
    
    public function postUpdate($event)
    {
        parent::postUpdate($event);
        ActivityObserver::getInstance()->notifyComponent($this, Log::ACTION_UPDATE);
    }
    
    public function postDelete($event)
    {
        parent::postDelete($event);
        ActivityObserver::getInstance()->notifyComponent($this, Log::ACTION_DELETE);
    }
    ...
    public function getIssuesQuery($hydrationMode = Doctrine::HYDRATE_ARRAY)
    {
        return Doctrine::getTable('Project_Issue')
            ->getComponentIssuesQuery($this->id, $hydrationMode);
    }
    ...
    public function fetchVersions($limit = null)
    {
        $sql = 
            ...
            "FROM project__component_version v ".
            "LEFT JOIN user uc ON uc.id = v.changer_id ".
            "WHERE v.id = :component_id ".
        ...
        $stmt = FreeCode_PDO_Manager::getInstance()
            ...
            ->prepare($sql);
        $id = $this->id;
        $stmt->bindParam(':component_id', $id, PDO::PARAM_INT);
        $stmt->execute();
